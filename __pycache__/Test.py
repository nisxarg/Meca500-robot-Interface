...
class MecaPendant(QWidget):
    ...
    def __init__(self):
        ...
        self.console.setStyleSheet("font-family: Consolas; font-size: 11px; color: lightgreen; background-color: #2b2b2b; border: 1px solid #555;")
        ...
        self.camera_label.setStyleSheet("font-size: 20px; color: gray; background-color: black; border: 1px solid #555;")
    ...
    def _apply_dark_theme(self):
        """Apply a comprehensive dark theme to the entire application"""
        dark_style = """
        QWidget {
